...
#ifndef PPP_RCV_TOUT 
        /*
         * Only marked packets are allowed to reset the idle timer.
         * Each Mark has a special meaning
         *  0x666 - WAN1 Query Packets
         *  0x888 - WAN1 Query Packets
         *  0x555 - Packet from LAN & DMZ
         */
		if (skb->nfmark != 0x666 &&  /* WAN1 Link Query Packets */
            skb->nfmark != 0x888 &&  /* WAN2 Link Query Packets */ 
            skb->nfmark != 0)        /* All other packets */
#endif 
