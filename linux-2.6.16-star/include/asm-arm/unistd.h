...
#define __NR_bcm_mdio_rreg      (__NR_SYSCALL_BASE+322)
#define __NR_bcm_mdio_wreg      (__NR_SYSCALL_BASE+323)
#define __NR_bcm_phy_opt        (__NR_SYSCALL_BASE+324)
#define __NR_star_reg_opt       (__NR_SYSCALL_BASE+325)
