...
static inline int xfrm_policy_check(struct sock *sk, int dir, struct sk_buff *skb, unsigned short family)
{
	...
	/* TF1: CONFIG_VIPSEC */
       extern int (*ipsec_policy_check_hook) (struct sock *sk, int dir,
                    struct sk_buff *skb, unsigned short family);
        return (ipsec_policy_check_hook == NULL) ||
            (*ipsec_policy_check_hook)(sk, dir, skb, family);
       /* TF1: CONFIG_VIPSEC */	 	
...
static inline int xfrm_route_forward(struct sk_buff *skb, unsigned short family)
{
	 ...
	 /* TF1: CONFIG_VIPSEC */
        return __xfrm_route_forward(skb, family);
        /* TF1: CONFIG_VIPSEC */
