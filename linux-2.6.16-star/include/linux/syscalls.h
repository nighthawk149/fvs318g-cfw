...
asmlinkage long compat_sys_openat(unsigned int dfd, const char __user *filename,
				   int flags, int mode);
asmlinkage void sys_bcm_mdio_rreg(unsigned char page, unsigned char reg, unsigned char *data, unsigned char len);
asmlinkage void sys_bcm_mdio_wreg(unsigned char page, unsigned char reg, unsigned char *data, unsigned char len);
asmlinkage int sys_bcm_phy_opt(unsigned char opt, unsigned char phy_addr, unsigned char phy_reg, unsigned short int * data);
asmlinkage void sys_star_reg_opt(unsigned char opt, unsigned long int addr, unsigned char *data, unsigned char len);
#endif
