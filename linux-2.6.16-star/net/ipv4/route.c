 ...
 *
 * Version:	$Id: route.c,v 1.1.6.3 2007/12/13 14:35:28 suheil Exp $
 *
 * Authors:	Ross Biro
...
/* TF1: CONFIG_VIPSEC */
void  (*ipsec_mcastforward_check_hook)(struct sk_buff *, u32, 
                                       unsigned char *) = NULL;
EXPORT_SYMBOL(ipsec_mcastforward_check_hook);
/* TF1: CONFIG_VIPSEC */
			       ...
			       u8 tos, struct net_device *dev)
{
	...
	/* TF1: CONFIG_VIPSEC */
        /* Function which does all the IPSec multicast/broadcast processing */
	       if (ipsec_mcastforward_check_hook != NULL) 
        (*ipsec_mcastforward_check_hook)(skb, daddr, &res.type);
	/* TF1: CONFIG_VIPSEC */           
