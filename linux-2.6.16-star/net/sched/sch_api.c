...
#ifndef NOT_TF1
int tc_ctl_tclass_ex(struct sk_buff *skb, struct nlmsghdr *n, void *arg)
    {
    return tc_ctl_tclass(skb, n, arg);
    }
EXPORT_SYMBOL(tc_ctl_tclass_ex);
int tc_modify_qdisc_ex(struct sk_buff *skb, struct nlmsghdr *n, void *arg)
{
    return tc_modify_qdisc(skb,n,arg);
}
EXPORT_SYMBOL(tc_modify_qdisc_ex);
#endif
...
EXPORT_SYMBOL(psched_us_per_tick);
EXPORT_SYMBOL(psched_tick_per_us);
#endif
