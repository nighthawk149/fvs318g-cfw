 ...
 * --------------------
 * 01a 23Nov09,sg added generic_ioctl
 */
...
static int generic_ioctl(unsigned int fd, unsigned int cmd, unsigned long arg)
{
	struct ifreq __user *ifr;
	struct ifreq32 __user *ifr32;
...
#ifdef TEAMF1_CHANGES
HANDLE_IOCTL(SIOCGENERIC, generic_ioctl)
#endif /* TEAMF1_CHANGES*/
